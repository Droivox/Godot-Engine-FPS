...
func _explosion() -> void:
	...
	var explosion_floor = preload("res://data/scenes/black_smoke.tscn").instance();
	main.add_child(explosion_floor);
	explosion_floor.translation = global_transform.origin;
